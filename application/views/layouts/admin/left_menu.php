<nav>
	<ul class="sidebar-menu" data-widget="tree">
        ...
        <li
			...
			href="javascript:void(0)"><i class="icon_key_alt"></i> <span>Pengaturan</span>
			...
			<ul class="treeview-menu" <?php if($menu_open==true){?>
				...
				<li <?php if($this->router->fetch_class()=="profile"){?>
					...
					href="<?php echo site_url('admin/profile/index'); ?>"><i
						class="icon_table"></i>Profil</a></li>
				<li <?php if($this->router->fetch_class()=="country"){?>
					class="active" <?php }?>><a
					href="<?php echo site_url('admin/country/index'); ?>"><i
						class="icon_table"></i>Negara</a></li>
				<li <?php if($this->router->fetch_class()=="company"){?>
					class="active" <?php }?>><a
					href="<?php echo site_url('admin/company/index'); ?>"><i
						class="icon_table"></i>Perusahaan</a></li>
				<li <?php if($this->router->fetch_class()=="users"){?>
					class="active" <?php }?>><a
					href="<?php echo site_url('admin/users/index'); ?>"><i
						class="icon_table"></i>Pengguna</a></li>
			</ul></li> 
        
         <?php
        $menu_open = false;
        if ($this->router->fetch_class() == "category" || $this->router->fetch_class() == "sub_category" || $this->router->fetch_class() == "product") {
            $menu_open = true;
        }
        ?>
        <li
			class="treeview <?php if($menu_open==true){?>menu-open<?php }?>"><a
			href="javascript:void(0)"><i class="icon_genius"></i> <span>Pengaturan Produk</span> <i class="fa fa-angle-right"></i></a>
			<ul class="treeview-menu" <?php if($menu_open==true){?>
				style="display: block;" <?php }?>>
				<li <?php if($this->router->fetch_class()=="category"){?>
					class="active" <?php }?>><a
					href="<?php echo site_url('admin/category/index'); ?>"><i
						class="icon_table"></i>Kategori</a></li>
				<li <?php if($this->router->fetch_class()=="sub_category"){?>
					class="active" <?php }?>><a
					href="<?php echo site_url('admin/sub_category/index'); ?>"><i
						class="icon_table"></i>Sub Kategori</a></li>
				<li <?php if($this->router->fetch_class()=="product"){?>
					class="active" <?php }?>><a
					href="<?php echo site_url('admin/product/index'); ?>"><i
						class="icon_table"></i>Produk</a></li>
			</ul></li> 
        
        <?php
        $menu_open = false;
        if ($this->router->fetch_class() == "supplier" || $this->router->fetch_class() == "purchase" || $this->router->fetch_class() == "item_purchase") {
            $menu_open = true;
        }
        ?>
        <li
			class="treeview <?php if($menu_open==true){?>menu-open<?php }?>"><a
			href="javascript:void(0)"><i class="icon_document_alt"></i> <span>Menu Vendor</span>
				<i class="fa fa-angle-right"></i></a>
			<ul class="treeview-menu" <?php if($menu_open==true){?>
				style="display: block;" <?php }?>>
				<li <?php if($this->router->fetch_class()=="supplier"){?>
					...
					href="<?php echo site_url('admin/supplier/index'); ?>"><i
						class="icon_table"></i>Data Vendor</a></li>
				<li <?php if($this->router->fetch_class()=="purchase"){?>
					class="active" <?php }?>><a
					href="<?php echo site_url('admin/purchase/index'); ?>"><i
						class="icon_table"></i>Pembelian</a></li>
				<li <?php if($this->router->fetch_class()=="item_purchase"){?>
					class="active" <?php }?>><a
					href="<?php echo site_url('admin/item_purchase/index'); ?>"><i
						class="icon_table"></i>Item Pembelian</a></li>
			</ul></li> 
        <?php
        $menu_open = false;
        if ($this->router->fetch_class() == "customers" || $this->router->fetch_class() == "invoice" || $this->router->fetch_class() == "item_invoice") {
            $menu_open = true;
        }
        ?>
        <li
			class="treeview <?php if($menu_open==true){?>menu-open<?php }?>"><a
			href="javascript:void(0)"><i class="icon_cart_alt"></i> <span>Menu Customer</span>
				<i class="fa fa-angle-right"></i></a>
			<ul class="treeview-menu" <?php if($menu_open==true){?>
				style="display: block;" <?php }?>>
        ...
        <li
			class="treeview <?php if($menu_open==true){?>menu-open<?php }?>"><a
			href="javascript:void(0)"><i class="icon_easel"></i> <span>Laporan</span>
				<i class="fa fa-angle-right"></i></a>
			<ul class="treeview-menu" <?php if($menu_open==true){?>
				style="display: block;" <?php }?>>
				...
				<li <?php if($this->router->fetch_class()=="report_invoice"){?>
					...
					href="<?php echo site_url('admin/report_invoice/index'); ?>"><i
						class="icon_table"></i>Penjualan</a></li>
			</ul></li>
