<a href="<?php echo site_url('admin/product/index'); ?>" onClick="return confirm('Apa kamu yakin ingin meninggalkan halaman ini?');"
	class="btn btn-info"><i class="arrow_left"></i> Daftar</a>
<h5 class="font-20 mt-15 mb-1"> <?php if($id<0){echo "Form";}else { echo "Edit Form";} echo " "; echo str_replace('_',' ','Produk'); ?></h5>
<!--Form to save data-->
<?php echo form_open_multipart('admin/product/save/'.$product['id'],array("class"=>"form-horizontal")); ?>
<div class="card">
	<div class="card-body">
		<div class="form-group">
			<label for="Product Name" class="col-md-4 control-label">Nama Produk</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Sub Category" class="col-md-4 control-label">Sub Kategori</label>
			<div class="col-md-8"> 
          <?php
        $this->CI = & get_instance();
        $this->CI->load->database();
		...
		<div class="form-group">
			<label for="Buying Price" class="col-md-4 control-label">Harga Beli</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Selling Price" class="col-md-4 control-label">Harga Jual</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Specification" class="col-md-4 control-label">Spesifikasi</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="PurchaseType" class="col-md-4 control-label">Type Pembelian</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="AssetType" class="col-md-4 control-label">Type Aset</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Serial Number" class="col-md-4 control-label">Nomer Seri</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="BarcodeNumber" class="col-md-4 control-label">Nomer Barcode</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Weight Per Product" class="col-md-4 control-label">Berat
				Per Produk</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Size Per Product" class="col-md-4 control-label">Ukuran Per
				Produk</label>
			<div class="col-md-8">
...
<div class="form-group">
	<div class="col-sm-offset-4 col-sm-8">
		<button type="submit" class="btn btn-success"><?php if(empty($product['id'])){?>Simpan<?php }else{?>Update<?php } ?></button>
	</div>
</div>
<?php echo form_close(); ?>
