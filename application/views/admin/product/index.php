...
<table class="table table-striped table-bordered">
    ...
    <tr>
		...
		<td><a
			href="<?php echo site_url('admin/product/details/'.$c['id']); ?>" title="Lihat detail"
			class="action-icon"> <i class="zmdi zmdi-eye"></i></a> <a
			href="<?php echo site_url('admin/product/save/'.$c['id']); ?>" title="Edit"
			class="action-icon"> <i class="zmdi zmdi-edit"></i></a> <a
			href="<?php echo site_url('admin/product/remove/'.$c['id']); ?>" title="Hapus"
