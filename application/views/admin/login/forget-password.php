			...
			<div class="row h-100 justify-content-center align-items-center">
				<div class="col-sm-10 col-md-7 col-lg-5 mx-auto">
					...
					<div class="middle-box">
						<div class="card">
							<div class="card-body">
								<h4 class="font-22">Reset Password Mu</h4>
								<p>Masukan alamat email mu, password anda akan ke reset dan notifikasi akan dikirim ke email kamu.</p>
                                <?=$msg?>
                                <!-- Form -->
                                <?php echo form_open_multipart('admin/login/forget_password_process',array("class"=>"form-horizontal")); ?>
									...
									<input type="email" name="email" id="email"
										...
										class="form-control password" placeholder="Alamat Email"
										required="">
								</div>
								<div class="btn-area">
									<button type="submit"
										class="btn btn-rounded btn-outline-primary py-2 px-4 btn-block mt-15 text-white">Kirim Password Baru</button>
								</div>
                                <?php echo form_close(); ?>
                                <a
