							...
							<div class="card-body p-4">
								<div class="row align-items-center">
									...
									<div class="col-md-6">
										...
										<div>
											<h4 class="font-24 mt-0">Gratis Pendaftaran</h4>
                                        ...
                                        <?php echo form_open_multipart('admin/login/register_process',array("class"=>"form-horizontal")); ?>
											...
											<label for="fullname">Nama Depan</label> <input
												class="form-control" type="text" name="first_name"
												id="first_name"
												value="<?php echo ($this->input->post('first_name') ? $this->input->post('first_name') : ''); ?>"
												placeholder="Masukan nama depan mu" required>
										</div>

										<div class="form-group">
											<label for="fullname">Nama Belakang</label> <input
										...
										<div class="form-group">
											<div class="custom-control custom-checkbox">
												<input type="checkbox" class="custom-control-input"
													...
													for="customCheck1"><span class="font-16">Saya Terima <a
														href="<?php echo base_url(); ?>public/riktheme/#"
														class="text-muted">Peraturan dan kebijakan</a></span></label>
											</div>
										</div>
                                        ...
                                        <a
											href="<?php echo site_url(); ?>/admin/login/index"
											class="text-dark float-right"><span
											class="font-12 text-primary">Kembali </span></a>
