								...
								<div class="row align-items-center">
									...
									<div class="col-md-6">
										...
										<div class="card-body-login mb-30">
                                         ...
                                         <?=$msg?>
                                        <h4 class="font-22 mb-30">Login</h4>
                                         ...
                                         <?php echo form_open_multipart('admin/login/login_process',array("class"=>"form-horizontal")); ?>
											...
											<input class="form-control" type="email" name="email"
												...
												required="" placeholder="Masukan Alamat Email mu">
										</div>
										...
										<div class="form-group">
											<a
												...
												class="font-12 text-primary">Lupa Password Mu?</span></a>
											...
											<div class="custom-control custom-checkbox pl-0">
												<div class="custom-control custom-checkbox">
													<input type="checkbox" class="custom-control-input"
														...
														for="customCheck1"><span class="font-16">Ingatkan Saya</span></label>
												</div>
											</div>
										</div>
                                        ...
                                        <a
											...
											class="text-dark float-right"><span
											class="font-12 text-primary">Buat Akun Baru </span></a>
									</div>
									<!-- end card-body -->
								</div>
								<!-- end card -->
