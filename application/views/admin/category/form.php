<a href="<?php echo site_url('admin/category/index'); ?>" onClick="return confirm('Apa kamu yakin meninggalkan halaman ini?');"
	class="btn btn-info"><i class="arrow_left"></i> Daftar</a>
<h5 class="font-20 mt-15 mb-1"><?php if($id<0){echo "Form";}else { echo "Edit Form";} echo " "; echo str_replace('_',' ','Kategori'); ?></h5>
<!--Form to save data-->
...
<div class="form-group">
	...
	<button type="submit" class="btn btn-success"><?php if(empty($category['id'])){?>Simpan<?php }else{?>Update<?php } ?></button>
	</div>
</div>
<?php echo form_close(); ?>
