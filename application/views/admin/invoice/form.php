<a href="<?php echo site_url('admin/invoice/index'); ?>" onClick="return confirm('Apa kamu yakin ingin meninggalkan halaman ini?');"
	class="btn btn-info"><i class="arrow_left"></i> Daftar</a>
<h5 class="font-20 mt-15 mb-1">
<?php if($id<0){echo "Form";}else { echo "Edit Form";} echo " "; echo str_replace('_',' ','Invoice'); ?></h5>
<!--*****************************************************
...
<div id="item_form_template" class="row hide">
	<div class="row item  index0">
		<div class="form-group">
			<label for="Product" class="col-md-12 control-label">Produk</label>
			<div class="col-md-12">
		...
		<div class="form-group">
			<label for="Item Cost" class="col-md-12 control-label">Harga/Item</label>
			<div class="col-md-12">
		...
		<div class="form-group">
			<label for="Item Quantity" class="col-md-12 control-label">Jumlah Item</label>
			<div class="col-md-12">
		...
		<div class="form-group">
			<label for="Item Total" class="col-md-12 control-label">Total Item</label>
			<div class="col-md-12">
		...
		<div class="form-group">
			<div class="removeitem" onClick="removeItem(0);">
				<a href="javascript:void();" class="action-icon" title="Hapus Produk"> <i
					class="zmdi zmdi-delete"></i></a>
			</div>
		</div>
		<div class="form-group">
			<div class="removeitem">
				<a href="<?php echo site_url('admin/product/save'); ?>" class="action-icon" title="Tambah Daftar Produk"> <i
					class="zmdi zmdi-file-plus"></i></a>
			</div>
		</div>
	</div>
</div>
...
<div class="card">
	<div class="card-body">		
		...
		<button type="button" onClick="addMore(event);" class="btn btn-danger">
			<i class="zmdi zmdi-plus"></i>Tambahkan Banyak Produk
		</button>
	</div>
</div>
...
function removeItem(index){
   var result = confirm("Apa kamu yakin akan menghapus item ini?");
   if(result==true){
    $(".index"+index ).remove();
   }
   //////////update cost/////////////
...
<div class="card">
  ...
  <div class="row">
	...
	<div class="col-md-4">
    <label for="Nick Name" class="col-md-4 control-label">Nama Panggilan</label>
    <div class="col-md-8">
	...
	<div class="form-group">
		<div class="removeitem">
			<a href="<?php echo site_url('admin/customers/save'); ?>" class="action-icon" title="Tambah Daftar Produk"> <i
				class="zmdi zmdi-file-plus"></i></a>
		</div>
	</div>
 </div>
...
<div class="card">
	<div class="card-body">
		<div class="form-group">
			<label for="Expedisi" class="col-md-4 control-label">Ekspedisi</label>
			<div class="col-md-8"> 
           	<?php
        		$enumArr = $this->customlib->getEnumFieldValues('invoice', 'expedisi');
        	?> 
            ...
            for ($i = 0; $i < count($enumArr); $i ++) {
             ...
             <option value="<?=$enumArr[$i]?>"
					<?php if($invoice['expedisi']==$enumArr[$i]){ echo "selected";} ?>><?=ucwords($enumArr[$i])?></option> 
             <?php
            }
            ?> 
           	</select>
		...
		<div class="form-group">
			<label for="Date Of Invoice" class="col-md-4 control-label">Tanggal Invoice</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Description" class="col-md-4 control-label">Deskripsi Pesanan</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Internal Notes" class="col-md-4 control-label">Catatan Internal</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Total Cost" class="col-md-4 control-label">Total Harga</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Amount P" class="col-md-4 control-label">Jumlah yang dibayarkan</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Payment" class="col-md-4 control-label">Pembayaran</label>
			<div class="col-md-8"> 
           	<?php
        		$enumArr = $this->customlib->getEnumFieldValues('invoice', 'payment');
        	?> 
            ...
            for ($i = 0; $i < count($enumArr); $i ++) {
                ?> 
             <option value="<?=$enumArr[$i]?>"
					<?php if($invoice['payment']==$enumArr[$i]){ echo "selected";} ?>><?=ucwords($enumArr[$i])?></option> 
             <?php
            }
            ?> 
           	</select>
		...
		<div class="form-group">
			...
			<div class="col-md-8"> 
           	<?php
        		$enumArr = $this->customlib->getEnumFieldValues('invoice', 'status');
        	?> 
            ...
            for ($i = 0; $i < count($enumArr); $i ++) {
                ?> 
             <option value="<?=$enumArr[$i]?>"
					<?php if($invoice['status']==$enumArr[$i]){ echo "selected";} ?>><?=ucwords($enumArr[$i])?></option> 
             <?php
            }
            ?> 
           	</select>
...
<div class="form-group">
    <div class="col-sm-offset-4 col-sm-8">
        <button type="submit" class="btn btn-success"><?php if(empty($invoice['id'])){?>Simpan<?php }else{?>Update<?php } ?></button>
    </div>
</div>
<?php echo form_close(); ?>
