<a href="<?php echo site_url('admin/purchase/index'); ?>" onClick="return confirm('Apa kamu yakin ingin meninggalkan halaman ini?');"
	class="btn btn-info"><i class="arrow_left"></i> Daftar</a>
<h5 class="font-20 mt-15 mb-1"><?php if($id<0){echo "Form";}else { echo "Edit Form";} echo " ";echo str_replace('_',' ','Pembelian'); ?></h5>
<!--*****************************************************
	...
	<div class="row item  index0">
		...
		<div class="form-group">
			<div class="removeitem" onClick="removeItem(0);">
				<a href="javascript:void();" class="action-icon" title="Hapus Item"> <i
					class="zmdi zmdi-delete"></i></a>
			</div>
		</div>
		<div class="form-group">
			<div class="removeitem">
				<a href="<?php echo site_url('admin/product/save'); ?>" class="action-icon" title="Tambah Daftar Barang"> <i
...
<div class="card">
	<div class="card-body">
		...
		<button type="button" onClick="addMore(event);" class="btn btn-danger">
			<i class="zmdi zmdi-plus"></i>Tambah Banyak Item
		</button>
	</div>
</div>
...
function removeItem(index){
   var result = confirm("Apa kamu yakin ingin menghapus item ini?");
   if(result==true){
    $(".index"+index ).remove();
   }
   //////////update cost/////////////
...
<div class="card">
  ...
  <div class="row">
    <div class="col-md-4">
        <label for="Supplier" class="col-md-4 control-label">Vendor</label>
        <div class="col-md-8">
	...
	<div class="form-group">
			<div class="removeitem">
				<a href="<?php echo site_url('admin/supplier/save'); ?>" class="action-icon" title="Tambah Daftar Barang"> <i
					class="zmdi zmdi-file-plus"></i></a>
			</div>
		</div>
 </div>
...
<h4 class="card-title mb-0">Pembelian Info</h4>
<div class="card">
	<div class="card-body">
		<div class="form-group">
			<label for="Date Of Purchase" class="col-md-4 control-label">Tanggal Pembelian</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="Total Cost" class="col-md-4 control-label">Harga Total</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			...
			<div class="col-md-8"> 
           	<?php
        		$enumArr = $this->customlib->getEnumFieldValues('purchase', 'pembayaran');
        	?> 
            ...
            for ($i = 0; $i < count($enumArr); $i ++) {
             ...
             <option value="<?=$enumArr[$i]?>"
					<?php if($purchase['pembayaran']==$enumArr[$i]){ echo "selected";} ?>><?=ucwords($enumArr[$i])?></option> 
             <?php
            }
            ?> 
           	</select>
...
<div class="form-group">
    <div class="col-sm-offset-4 col-sm-8">
        <button type="submit" class="btn btn-success"><?php if(empty($purchase['id'])){?>Simpan<?php }else{?>Update<?php } ?></button>
    </div>
</div>
<?php echo form_close(); ?>
