<a href="<?php echo site_url('admin/users/index'); ?>" onClick="return confirm('Apa kamu yakin ingin meninggalkan halaman ini?');"
	class="btn btn-info"><i class="arrow_left"></i> Daftar</a>
<h5 class="font-20 mt-15 mb-1"><?php if($id<0){echo "Form";}else { echo "Edit Form";} echo " ";echo str_replace('_',' ','Pengguna'); ?></h5>
<!--Form to save data-->
...
<div class="card">
	<div class="card-body">
		...
		<div class="form-group">
			<label for="User Type" class="col-md-4 control-label">Type Pengguna</label>
			<div class="col-md-8"> 
           	<?php
