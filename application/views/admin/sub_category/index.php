...
<table class="table table-striped table-bordered">
    ...
    <tr>
		...
		<td><a
			href="<?php echo site_url('admin/sub_category/details/'.$c['id']); ?>" title="Lihat detail"
			class="action-icon"> <i class="zmdi zmdi-eye"></i></a> <a
			href="<?php echo site_url('admin/sub_category/save/'.$c['id']); ?>" title="Edit"
			class="action-icon"> <i class="zmdi zmdi-edit"></i></a> <a
			href="<?php echo site_url('admin/sub_category/remove/'.$c['id']); ?>" title="Hapus"
