...
*********#////mpdf header footer page no******************
****************************************************-->
Jumlah Invoice: <?php echo $invoice_item_quantity;?><br>
Total Invoice: <?php echo $invoice_item_total;?><br>
<hr>
...
<table border="1" cellspacing="3" cellpadding="3" class="table" align="center" width="100%">
	<tr>
		...
		<th align="center">Expedisi</th>
		<th align="center">Total Harga</th>
		<th align="center">Jumlah yang dibayar</th>
