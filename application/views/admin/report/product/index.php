<h5 class="font-20 mt-15 mb-1">Laporan Produk</h5>
<!--Form of products Paramaters-->
<?php echo form_open_multipart('admin/report_product/report/',array("class"=>"form-horizontal")); ?>
<div class="card">
	<div class="card-body">
		<div class="form-group">
			<code>Agar dapat melihat laporan penuh invoice, biarkan field kosong</code>
			<div class="col-md-8">
				<label for="Date From" class="col-md-4 control-label">Dari Tanggal</label>
				<div class="col-md-4">
				...
				<label for="Date To" class="col-md-4 control-label">Sampai Tanggal</label>
				<div class="col-md-4">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-6 col-xl-3">
					<div class="card">
						<div class="card-body">
							<h5 class="font-16">Jumlah Pembelian</h5>
				...
				<div class="col-md-6 col-xl-3">
					<div class="card">
						<div class="card-body ">
							<h5 class="font-16">Total Pembelian</h5>
							<h2 class="text-green font-24">
								<i class="fa fa-play fa-rotate-270"></i> Up
							</h2>
			...
			<div class="row">
				<div class="col-md-6 col-xl-3">
					<div class="card">
						<div class="card-body">
							<h5 class="font-16">Jumlah Terjual</h5>
							<h2 class="text-green font-24">
								<i class="fa fa-play fa-rotate-270"></i> Up
							</h2>
				...
				<div class="col-md-6 col-xl-3">
					<div class="card">
						<div class="card-body ">
							<h5 class="font-16">Total Terjual</h5>
							<h2 class="text-green font-24">
								<i class="fa fa-play fa-rotate-270"></i> Up
							</h2>
