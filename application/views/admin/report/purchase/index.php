<h5 class="font-20 mt-15 mb-1">Laporan Pembelian</h5>
        ...
        <div class="form-group">
            <div class="col-md-8">
               <select name="report_type">
                 <option value="summary" <?php if($this->input->post('report_type')=='summary') {echo "selected";}; ?>>Ringkasan</option>
                 <option value="details" <?php if($this->input->post('report_type')=='details') {echo "selected";}; ?>>Detail</option>
               </select>
            </div>
		</div>
	</div>
