				...
				<div class="d-flex justify-content-between align-items-center">
					...
					<div
						...
						<i class="fa fa-arrow-right mr-1"></i> <span
                            ...
                            <a
					href="<?php echo site_url('admin/customers/index'); ?>">Selengkapnya</a>
                            </span>
					</div>
				</div>
			</div>
				...
				<div class="d-flex justify-content-between align-items-center">
					...
					<div
						...
						<i class="fa fa-arrow-right mr-1"></i> <span
							class=" text-extra-small">
                            <a
					href="<?php echo site_url('admin/supplier/index'); ?>">Selengkapnya</a>
                            </span>
					</div>
				</div>
			</div>
				...
				<div class="d-flex justify-content-between align-items-center">
					...
					<div
						...
						<i class="fa fa-arrow-right mr-1"></i> <span
							class=" text-extra-small">
                            <a
					href="<?php echo site_url('admin/purchase/index'); ?>">Selengkapnya</a>
                            </span>
					</div>
				</div>
			</div>
				...
				<div class="d-flex justify-content-between align-items-center">
					...
					<div
						...
						<i class="fa fa-arrow-right mr-1"></i> <span
							class=" text-extra-small">
                            <a
					href="<?php echo site_url('admin/invoice/index'); ?>">Selengkapnya</a>
                            </span>
					</div>
				</div>
			</div>
